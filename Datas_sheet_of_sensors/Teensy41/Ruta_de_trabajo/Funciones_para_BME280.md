...
```ino
/*
Declara una instancia llamada Serial
*/
...
```
# Serial.begin
Primero se ingresa los bautios, sin embargo en teensy no es necesario, pero igual se pone porque ya las funciones estan definidas y entonces poner este número es para ignorar cualquier error que aparesca

luego es espera hasta que se inicialize la coneccion primero se espera 2 segundo hasta que se inicialise la comicación con el monitor

y luego se espera para la comunicacion con el usb
